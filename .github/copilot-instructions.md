...
- All code changes should be covered by tests to ensure reliability and maintainability.
...
- In order to consider your task complete you must:
  ...
  - All these steps must be completed against the same codebase. If any of these steps fail, you must re-run all the steps after making changes.
